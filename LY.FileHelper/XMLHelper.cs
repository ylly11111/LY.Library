...
namespace LY.FileHelper
{
    ...
    public class XmlHelper
    {
        ...
        public bool IsNodeExist(string NodeName)
        {
            ...
            var node = objXmlDoc.SelectSingleNode(NodeName);
        ...
        public void Replace(string XmlPathNode, string Attname, string AttContext)
        {
            objXmlDoc.Load(strXmlFile);
            //更新节点内容。 
            objXmlDoc.SelectSingleNode(XmlPathNode).Attributes[Attname].Value = AttContext;
            Save();
        }
        ...
        public string GetNodeAttData(string XmlPathNode, string AttName)
        {
            objXmlDoc.Load(strXmlFile);
            //更新节点内容。 
            return objXmlDoc.SelectSingleNode(XmlPathNode).Attributes[AttName].Value;
        }
        ...
        public void InsertElement(string MainNode, string Element, List<string> Attrib, List<string> AttribContent, string Content)
        {
            //插入一个节点，带一属性。 
